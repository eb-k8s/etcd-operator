...
import (
	...
	_ "github.com/Facecircccccle/etcd-operator/pkg/util/retryutil"
...
func CreateClientService(kubecli kubernetes.Interface, clusterName, ns string, owner metav1.OwnerReference) error {
	...
	return createService(kubecli, ClientServiceName(clusterName), clusterName, ns, "", ports, owner, false, ctx)
}
...
func CreatePeerService(kubecli kubernetes.Interface, clusterName, ns string, owner metav1.OwnerReference) error {
	...
	return createService(kubecli, clusterName, clusterName, ns, v1.ClusterIPNone, ports, owner, true, ctx)
}

func createService(kubecli kubernetes.Interface, svcName, clusterName, ns, clusterIP string, ports []v1.ServicePort, owner metav1.OwnerReference, publishNotReadyAddresses bool, ctx context.Context) error {
